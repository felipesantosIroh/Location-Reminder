...
class RemindersActivityTest :
    ...
    @Test
    fun saveReminder_withNoTitle_showSnackBarError() = runBlocking {
    ...
    @Test
    fun saveReminder_withNoLocation_showSnackBarError() = runBlocking {
        val activityScenario =  ActivityScenario.launch(RemindersActivity::class.java)
        dataBindingIdlingResource.monitorActivity(activityScenario)
    ...
    @Test
    fun saveReminderWithData_BackToListReminders() = runBlocking {
        val activityScenario =  ActivityScenario.launch(RemindersActivity::class.java)
        dataBindingIdlingResource.monitorActivity(activityScenario)
